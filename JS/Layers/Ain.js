addLayer('Ain',
{
    ...
    microtabs:
    {
        Tab1:
        {
            ...
            'Abyss':
            {
                unlocked :  function()
                {
                    return player.Ain.MiniTab4_Shown
                },
                content :  function()
                {
                    var Format = []
                    ...
                    Format.push('blank')
                    Format.push('blank')
                    Format.push(['column',[['row',[['clickable',51],['column',,{'width':'18px'}],['clickable',52],['column',,{'width':'18px'}],['clickable',53],['column',,{'width':'18px'}],['clickable',54],['column',,{'width':'18px'}],['clickable',55]]],[]],{'width':'900px'}])
                    Format.push('blank')
                    Format.push('blank')
                    Format.push('blank')
                    Format.push(['display-text',player.Ain.Abyss_Descrption])
                    Format.push('blank')
                    Format.push('h-line','')
                    Format.push('blank')
                    Format.push(['display-text',player.Ain.Abyss_Status])
                    Format.push('blank')
                    Format.push('blank')
                    Format.push(['clickable',59])
                    return Format
                }
            }
        }
    ...
    {    
        ...
        Abyss_Descrption            : '<br>',
        Abyss_Status                : '<br>',
        // 1.Type(-1:Unlimitted, >0:Limitted) 2.Completes, 3.Effect, 4.InEffect, 5.Debuff
        Abyss                       :[0,[0,new Decimal(0), new Decimal(0), new Decimal(1), new Decimal(0), new Decimal(0)],
                                        [0,new Decimal(0), new Decimal(0), new Decimal(0), new Decimal(0), new Decimal(0)],
                                        [0,new Decimal(0), new Decimal(0), new Decimal(0), new Decimal(0), new Decimal(0)],
                                        [0,new Decimal(0), new Decimal(0), new Decimal(0), new Decimal(0), new Decimal(0)],
                                        [0,new Decimal(0), new Decimal(0), new Decimal(0), new Decimal(0), new Decimal(0)],
                                     ],
    ...
    update :  function(diff)
    {
        ...
        // Ain 挑战
          // 第一挑战内容：4-挑战内可获得效果，5-挑战的削弱
        player.Ain.Abyss[1][5] = (player.Ain.Abyss_Inchallenge == 1 ? new Decimal(2).pow(player.Ain.Clickables_2[1][1].add(player.Ain.Clickables_2[2][1]).add(player.Ain.Clickables_2[3][1])) 
                                                                    : new Decimal(1)) 
        player.Ain.Abyss[1][4] = (player.Ain.Abyss_Inchallenge == 1 ? player.Ain.points.max(1).div(1000000).log(1.05).add(1).max(1)
                                                                    : new Decimal(1))

        // Ain 高研究：研究上限数量部分
        player.Ain.Clickables_3[1][1]  = -1
        player.Ain.Clickables_3[2][1]  = -1
        player.Ain.Clickables_3[3][1]  = 1
        player.Ain.Clickables_3[4][1]  = 1
        player.Ain.Clickables_3[5][1]  = -1
        player.Ain.Clickables_3[7][1]  = 1
        player.Ain.Clickables_3[6][1]  = 1
        player.Ain.Clickables_3[8][1]  = -1
        player.Ain.Clickables_3[9][1]  = 1
        player.Ain.Clickables_3[10][1] = 1
        player.Ain.Clickables_3[11][1] = -1
        player.Ain.Clickables_3[12][1] = 1
        ...
        player.Ain.Clickables_3[3][4]   = new Decimal(2500000   )
        player.Ain.Clickables_3[4][4]   = new Decimal(50000000  )
        ...
        player.Ain.Clickables_3[7][4]   = new Decimal(25000000  )
        ...
        player.Ain.Clickables_3[9][4]   = new Decimal(5000000   )
        player.Ain.Clickables_3[10][4]  = new Decimal(5000000000)
        ...
        player.Ain.Clickables_3[12][3]  = player.Ain.Clickables_3[1][2].add(player.Ain.Clickables_3[2][2]).add(player.Ain.Clickables_3[5][2]).add(player.Ain.Clickables_3[8][2]).add(player.Ain.Clickables_3[11][2]).mul(0.001).add(1)
        player.Ain.Clickables_3[12][4]  = new Decimal(2500000   )
        player.Ain.Clickables_3[13][4]  = new Decimal(1000000000)
        if(player.Ain.Clickables_3[3][2].lte(0))
        {
            player.Ain.Clickables_3_13 = 0
            player.Ain.Clickables_3[3][3] = new Decimal(1)
        }
        if(player.Ain.Clickables_3[3][2].gte(1))
        {
            player.Ain.Clickables_3_13 += diff
            if(player.Ain.Clickables_3_13 >= 1)
            {
                var Difference = Math.floor(player.Ain.Clickables_3_13-1)
                player.Ain.Clickables_3[3][3] = player.Ain.Clickables_3[3][3].add(Difference*0.1)
                player.Ain.Clickables_3_13 -= Difference
            }
        }
        if(player.Ain.Clickables_3[9][2].gte(1)) player.Ain.MiniTab4_Shown = 1
        ...
        player.Ain.Clickables_2[1][2] = player.Ain.Clickables_2[1][2].mul((player.Ain.Abyss_Inchallenge == 1) ? new Decimal(1)
                                                                                                              : player.Ain.Abyss[1][3])
        ...
        if(player.Ain.Abyss_Inchallenge == 1)
        {
            player.Ain.Clickables_2[1][3] = player.Ain.Clickables_2[1][3].mul(player.Ain.Abyss[1][5])
            player.Ain.Clickables_2[2][3] = player.Ain.Clickables_2[2][3].mul(player.Ain.Abyss[1][5])
            player.Ain.Clickables_2[3][3] = player.Ain.Clickables_2[3][3].mul(player.Ain.Abyss[1][5])
        }
        ...
        for(var I=1; I<=8; I++)
        {
            ...
            player.Ain.Clickables_1[I][2] = player.Ain.Clickables_1[I][2].mul((player.Ain.Abyss_Inchallenge == 1) ? new Decimal(1)
                                                                                                                  : player.Ain.Abyss[1][3])
            if(player.Ain.Clickables_3[4][2].gte(1)) player.Ain.Clickables_1[I][2] = player.Ain.Clickables_1[I][2].mul(player.Ain.Clickables_1[I][1].mul(0.01).mul(I).mul(I).add(1))
            // Ain 价格
            player.Ain.Clickables_1[I][3] = new Decimal(Math.E).pow(new Decimal(0.25).mul(player.Ain.Clickables_1[I][1])).mul(10)  .mul(player.Ain.Clickables_2[3][2])
            if(player.Ain.Abyss_Inchallenge == 1) player.Ain.Clickables_1[I][3] = player.Ain.Clickables_1[I][3].mul(player.Ain.Abyss[1][5])
            player.Ain.Clickables_1[I][3] = player.Ain.Clickables_1[I][3].ceil()
        ...
        player.Ain.Point_Gain_Multiply = player.Ain.Point_Gain_Multiply.mul(player.Ain.Clickables_3[3][3])
        ...
        if(player.Ain.Clickables_3[12][2].gte(1)) player.Ain.Point_Gain_Exponent = player.Ain.Point_Gain_Exponent.mul(player.Ain.Clickables_3[12][3])
        ...
        if(player.Ain.Clickables_3[5][3].mul(player.Ain.Refactor[2]).gte(1))  player.Ain.Deep_Research_Power = player.Ain.Deep_Research_Power.mul(player.Ain.Clickables_3[5][3].mul(player.Ain.Refactor[2]))
                                                                              player.Ain.Deep_Research_Power = player.Ain.Deep_Research_Power.mul(player.Ain.Abyss[1][3].mul(0.25).max(1))
        if(player.Ain.Abyss_Inchallenge == 1)                                 player.Ain.Deep_Research_Power = new Decimal(0)
        ...
        if(player.Ain.Clickables_3[5][3].mul(player.Ain.Refactor[2]).gte(1))  player.Ain.Deep_Research_Gain = player.Ain.Deep_Research_Gain.mul(player.Ain.Clickables_3[5][3].mul(player.Ain.Refactor[2]))
                                                                              player.Ain.Deep_Research_Gain = player.Ain.Deep_Research_Gain.mul(player.Ain.Abyss[1][3].mul(0.25).max(1))
        ...
        if(player.Ain.Abyss_Inchallenge == 1)                                 player.Ain.Deep_Research_Gain = new Decimal(0)

        // 计算研究：执行研究部分
        for(var I=1; I<player.Ain.Clickables_3.length; I++)
        {
        ...
        switch(player.Ain.Deep_Research_TextNo)
        {
            case 11:  player.Ain.Deep_Research_Text = '<p style="transform:scale(2,2)">[A1]</p><br><h1>Spring Up</h1><br><br><h2>Lv. ' + formatWhole(player.Ain.Clickables_3[1][2]) + '</h2><br>Recycling Research<br><h1>--------------</h1><h2>Multiply Ain production<br><br>×' + format(player.Ain.Clickables_3[1][3]) + '</h2><br>'
                      ;break
            case 12:  player.Ain.Deep_Research_Text = player.Ain.Clickables_3[1][2].gt(0)  ? '<p style="transform:scale(2,2)">[A2]</p><br><h1>Refactor EX</h1><br><br><h2>Lv. ' + formatWhole(player.Ain.Clickables_3[2][2]) + '</h2><br>Recycling Research<br><h1>--------------</h1><h2>Multiply<br>[Refactor] Effect<br><br>×' + format(player.Ain.Clickables_3[2][3]) + '</h2><br>'
                                                                                           : '<p style="transform:scale(2,2)">[A2]</p><br><h1>?????</h1><br><br><h2>Lv. ?</h2><br>Unknown Research Type<br><h1>--------------</h1><br><h2>Unknown Effect</h2><br>'
                      ;break
            case 13:  player.Ain.Deep_Research_Text = player.Ain.Clickables_3[2][2].gt(0)  ? '<p style="transform:scale(2,2)">[A3]</p><br><h1>Dissociation</h1><br><br><h2>Lv. ' + formatWhole(player.Ain.Clickables_3[3][2]) + '/' + formatWhole(player.Ain.Clickables_3[3][1]) + '</h2><br><br>Finite Research<br><h1>--------------</h1><h2>The time spent<br>will multiply<br>Ain gain<br><br>(Only start time counting when this research is done)<br><br>×' + format(player.Ain.Clickables_3[3][3]) + '<br><br>'
                                                                                           : '<p style="transform:scale(2,2)">[A3]</p><br><h1>?????</h1><br><br><h2>Lv. ?</h2><br>Unknown Research Type<br><h1>--------------</h1><br><h2>Unknown Effect</h2><br>'
                      ;break
            case 14:  player.Ain.Deep_Research_Text = player.Ain.Clickables_3[3][2].gt(0)  ? '<p style="transform:scale(2,2)">[A4]</p><br><h1>Depth Effect</h1><br><br><h2>Lv. ' + formatWhole(player.Ain.Clickables_3[4][2]) + '/' + '0' + '<br></h2>Finite Research<br><h1>--------------</h1><h2>Depth of Ain Hierarchy increase its production<br>'
                                                                                           : '<p style="transform:scale(2,2)">[A4]</p><br><h1>?????</h1><br><br><h2>Lv. ?</h2><br>Unknown Research Type<br><h1>--------------</h1><br><h2>Unknown Effect</h2><br>'
                      ;break
            case 15:  player.Ain.Deep_Research_Text = player.Ain.Clickables_3[2][2].gt(0)  ? '<p style="transform:scale(2,2)">[A5]</p><br><h1>Knowledge Framework Reconstruction</h1><br><br><h2>Lv. ' + formatWhole(player.Ain.Clickables_3[5][2]) + '</h2><br>Recycling Research<br><h1>--------------</h1><h2>[Refactor] will multiply RP by percentage<br><br>×' + format(player.Ain.Refactor[2]) + '<br>×' + format(player.Ain.Clickables_3[5][3].mul(100)) + '%<br>------------<br>≈ ×' + format(player.Ain.Clickables_3[5][3].mul(player.Ain.Refactor[2])) + '</h2><br>'
                                                                                           : '<p style="transform:scale(2,2)">[A5]</p><br><h1>?????</h1><br><br><h2>Lv. ?</h2><br>Unknown Research Type<br><h1>--------------</h1><br><h2>Unknown Effect</h2><br>'
                      ;break
            case 16:  player.Ain.Deep_Research_Text = player.Ain.Clickables_3[5][2].gt(0)  ? '<p style="transform:scale(2,2)">[A6]</p><br><h1>Enlarge refactor<br>range</h1><br><br><h2>Lv. ' + formatWhole(player.Ain.Clickables_3[6][2]) + '/' + formatWhole(player.Ain.Clickables_3[6][1]) + '</h2><br>Finite Research<br><h1>--------------</h1><h2>[Refactor]<br>will also include the three buyables in Simple Research'
                                                                                           : '<p style="transform:scale(2,2)">[A6]</p><br><h1>?????</h1><br><br><h2>Lv. ?</h2><br>Unknown Research Type<br><h1>--------------</h1><br><h2>Unknown Effect</h2><br>'
                      ;break
            case 17:  player.Ain.Deep_Research_Text = player.Ain.Clickables_3[6][2].gt(0)  ? '<p style="transform:scale(2,2)">[A7]</p><br><h1>Analyse</h1><br><br><h2>Lv. ' + formatWhole(player.Ain.Clickables_3[4][2]) + '/' + formatWhole(player.Ain.Clickables_3[13][1]) + '<br></h2>Finite Research<br><h1>--------------</h1><h2>Unlock new<br>features<br>'
                                                                                           : '<p style="transform:scale(2,2)">[A7]</p><br><h1>?????</h1><br><br><h2>Lv. ?</h2><br>Unknown Research Type<br><h1>--------------</h1><br><h2>Unknown Effect</h2><br>'
                      ;break
            case 18:  player.Ain.Deep_Research_Text = player.Ain.Clickables_3[1][2].gt(0)  ? '<p style="transform:scale(2,2)">[A8]</p><br><h1>Note</h1><br><br><h2>Lv. ' + formatWhole(player.Ain.Clickables_3[8][2]) + '</h2><br>Recycling Research<br><h1>--------------</h1><h2>Multiply RP production<br><br>×' + format(player.Ain.Clickables_3[8][3]) + '</h2><br>'
                                                                                           : '<p style="transform:scale(2,2)">[A8]</p><br><h1>?????</h1><br><br><h2>Lv. ?</h2><br>Unknown Research Type<br><h1>--------------</h1><br><h2>Unknown Effect</h2><br>'
                      ;break
            case 19:  player.Ain.Deep_Research_Text = player.Ain.Clickables_3[8][2].gt(0)  ? '<p style="transform:scale(2,2)">[A9]</p><br><h1>Abyss</h1><br><br><h2>Lv. ' + formatWhole(player.Ain.Clickables_3[10][2]) + '/' + formatWhole(player.Ain.Clickables_3[13][1]) + '<br></h2>Finite Research<br><h1>--------------</h1><h2>Unlock new<br>features<br>'
                                                                                           : '<p style="transform:scale(2,2)">[A9]</p><br><h1>?????</h1><br><br><h2>Lv. ?</h2><br>Unknown Research Type<br><h1>--------------</h1><br><h2>Unknown Effect</h2><br>'
                      ;break
            case 110: player.Ain.Deep_Research_Text = player.Ain.Clickables_3[9][2].gt(0)  ? '<p style="transform:scale(2,2)">[A10]</p><br><h1>Abyss</h1><br><br><h2>Lv. ' + formatWhole(player.Ain.Clickables_3[10][2]) + '/' + formatWhole(player.Ain.Clickables_3[13][1]) + '<br></h2>Finite Research<br><h1>--------------</h1><h2>Unlock new<br>features<br>'
                                                                                           : '<p style="transform:scale(2,2)">[A10]</p><br><h1>?????</h1><br><br><h2>Lv. ?</h2><br>Unknown Research Type<br><h1>--------------</h1><br><h2>Unknown Effect</h2><br>'
                      ;break
            case 111: player.Ain.Deep_Research_Text = player.Ain.Clickables_3[8][2].gt(0)  ? '<p style="transform:scale(2,2)">[A11]</p><br><h1>Summary</h1><br><br><h2>Lv. ' + formatWhole(player.Ain.Clickables_3[11][2]) + '</h2><br>Recycling Research<br><h1>--------------</h1><h2>Increase the max level of<br>[Knowledge]<br><br>+' + formatWhole(player.Ain.Clickables_3[11][3]) + '</h2><br>'
                                                                                           : '<p style="transform:scale(2,2)">[A1]</p><br><h1>?????</h1><br><br><h2>Lv. ?</h2><br>Unknown Research Type<br><h1>--------------</h1><br><h2>Unknown Effect</h2><br>'
                      ;break
            case 112: player.Ain.Deep_Research_Text = player.Ain.Clickables_3[11][2].gt(0) ? '<p style="transform:scale(2,2)">[A12]</p><br><h1>Research Bonus</h1><br><br><h2>Lv. ' + formatWhole(player.Ain.Clickables_3[2][2]) + '</h2><br>Recycling Research<br><h1>--------------</h1><h2>The total level of A1 A2 A5 A8 A11 power the Ain gain<br><br>^' + format(player.Ain.Clickables_3[12][3]) + '</h2><br>'
                                                                                           : '<p style="transform:scale(2,2)">[A12]</p><br><h1>?????</h1><br><br><h2>Lv. ?</h2><br>Unknown Research Type<br><h1>--------------</h1><br><h2>Unknown Effect</h2><br>'
                      ;break
            case 113: player.Ain.Deep_Research_Text = player.Ain.Clickables_3[12][2].gt(0) ? '<p style="transform:scale(2,2)">[A13]</p><br><h1>Resting?<br>No Allowed!</h1><br><br><h2>Lv. ' + formatWhole(player.Ain.Clickables_3[13][2]) + '/' + formatWhole(player.Ain.Clickables_3[13][1]) + '<br></h2>Finite Research<br><h1>--------------</h1><h2>RP will multiply<br>Ain production if not researching<br><br>×' + format(player.Ain.Clickables_3[13][3]) + '</h2><br>'
                                                                                           : '<p style="transform:scale(2,2)">[A13]</p><br><h1>?????</h1><br><br><h2>Lv. ?</h2><br>Unknown Research Type<br><h1>--------------</h1><br><h2>Unknown Effect</h2><br>'
                      ;break
            default : 
            {
                // 正在研究时的强制文本
                ...
                if(player.Ain.Clickables_3[3][6]  == 1) player.Ain.Deep_Research_Text = '<p style="transform:scale(2,2)">[A3]</p><br><h1>Dissociation</h1><br><br><h2>Lv. ' + formatWhole(player.Ain.Clickables_3[3][2]) + '/' + formatWhole(player.Ain.Clickables_3[3][1]) + '</h2><br><br>Finite Research<br><h1>--------------</h1><h2>The time spent<br>will multiply<br>Ain gain<br><br>(Only start time counting when this research is done)<br><br>×' + format(player.Ain.Clickables_3[3][3]) + '<br><br>'
                ...
                if(player.Ain.Clickables_3[9][6]  == 1) player.Ain.Deep_Research_Text = '<p style="transform:scale(2,2)">[A9]</p><br><h1>Abyss</h1><br><br><h2>Lv. ' + formatWhole(player.Ain.Clickables_3[10][2]) + '/' + formatWhole(player.Ain.Clickables_3[13][1]) + '<br></h2>Finite Research<br><h1>--------------</h1><h2>Unlock new<br>features<br>'
                ...
                if(player.Ain.Clickables_3[12][6] == 1) player.Ain.Deep_Research_Text = '<p style="transform:scale(2,2)">[A12]</p><br><h1>Research Bonus</h1><br><br><h2>Lv. ' + formatWhole(player.Ain.Clickables_3[12][2]) + '</h2><br>Recycling Research<br><h1>--------------</h1><h2>The total level of A1 A2 A5 A8 A11 power the Ain gain<br><br>^' + format(player.Ain.Clickables_3[12][3]) + '</h2><br>'
        ...
        //
        if(player.Ain.Abyss_Select == 0) player.Ain.Abyss_Descrption = '<h1>Click the button above to select a challenge.</h1>'
        if(player.Ain.Abyss_Select == 1) player.Ain.Abyss_Descrption = '<h1>Serious Mistake</h1><br><br>You found some serious mistakes in your research. You need to abandon everything to fix them.<br><br><br><br><br>Unlimitted Challenge<br><br>Enter: This challenge will TEMPORARY reset EVERYTHING in [Depths], [Simple Research] and [Deep Research],<br>and reset Ains. (You can get them back when leaving)<br><br>Challenge Description: [Simple Research] will increase all the price in [Depths] and [Simple Research]. <br>[Deep Research] and all buffs from [Abyss] is not availiable. When leaving, reset Ains.<br><br>Reward:Multiply Ain Hierarchy(×1), [Ain Obtain](×1) and Research Power(×0.25).<br>(The magnification won\'t less than 1)<br><br><h1>×' + format(player.Ain.Abyss[1][3])
    
        //
        if(player.Ain.Abyss_Inchallenge == 0) player.Ain.Abyss_Status = '<h1>You are not in any challenge now</h1>'
        if(player.Ain.Abyss_Inchallenge == 1) player.Ain.Abyss_Status = '<h1>You are in challenge [Serious Mistake]<br><br>When leave get: ×' + format(player.Ain.Abyss[1][4]) + '</h1>'
    },
        ...
        Progress: {
            ...
            progress : function()
            {
                switch(player.Ain.Deep_Research_Text.substring(33,36))
                {
                    ...
                    case 'A3]' : if(player.Ain.Clickables_3[3][2] .lt(player.Ain.Clickables_3[3][1] )) { return player.Ain.Clickables_3[3][5] .div(player.Ain.Clickables_3[3][4])  }
                                 else                                                                  { return 100 } ;break
                    case 'A4]' : if(player.Ain.Clickables_3[4][2] .lt(player.Ain.Clickables_3[4][1] )) { return player.Ain.Clickables_3[4][5] .div(player.Ain.Clickables_3[4][4])  }
                                 else                                                                  { return 100 } ;break
                    ...
                    case 'A7]' : if(player.Ain.Clickables_3[7][2] .lt(player.Ain.Clickables_3[7][1] )) { return player.Ain.Clickables_3[7][5] .div(player.Ain.Clickables_3[7][4])  }
                                 else                                                                  { return 100 } ;break
                    case 'A8]' : return player.Ain.Clickables_3[8][5] .div(player.Ain.Clickables_3[8][4] )            ;break
                    case 'A9]' : if(player.Ain.Clickables_3[9][2] .lt(player.Ain.Clickables_3[9][1] )) { return player.Ain.Clickables_3[9][5] .div(player.Ain.Clickables_3[9][4])  }
                                 else                                                                  { return 100 } ;break
                    case 'A10' : if(player.Ain.Clickables_3[10][2].lt(player.Ain.Clickables_3[10][1])) { return player.Ain.Clickables_3[10][5].div(player.Ain.Clickables_3[10][4]) }
                                 else                                                                  { return 100 } ;break
                    case 'A11' : return player.Ain.Clickables_3[11][5].div(player.Ain.Clickables_3[11][4])            ;break
                    case 'A12' : if(player.Ain.Clickables_3[12][2].lt(player.Ain.Clickables_3[12][1])) { return player.Ain.Clickables_3[12][5].div(player.Ain.Clickables_3[12][4]) }
                                 else                                                                  { return 100 } ;break
                    case 'A13' : if(player.Ain.Clickables_3[13][2].lt(player.Ain.Clickables_3[13][1])) { return player.Ain.Clickables_3[13][5].div(player.Ain.Clickables_3[13][4]) }
                                 else                                                                  { return 100 } ;break
                }
            },
            display : function()
            {
                switch(player.Ain.Deep_Research_Text.substring(33,36))
                {
                    ...
                    case 'A2]' : return format(player.Ain.Clickables_3[2][5] )  + ' / ' + (player.Ain.Clickables_3[1][2].gt(0) ? format(player.Ain.Clickables_3[2][4]) : '???') ;break
                    case 'A3]' : if(player.Ain.Clickables_3[3][2] .lt(player.Ain.Clickables_3[3][1]))  { return format(player.Ain.Clickables_3[3][5])   + ' / ' + (player.Ain.Clickables_3[2][2].gt(0)  ? format(player.Ain.Clickables_3[3][4])  : '???') }
                                 else                                                                  { return 'Completed' }   ;break
                    case 'A4]' : if(player.Ain.Clickables_3[4][2] .lt(player.Ain.Clickables_3[4][1]))  { return format(player.Ain.Clickables_3[4][5])   + ' / ' + (player.Ain.Clickables_3[3][2].gt(0)  ? format(player.Ain.Clickables_3[4][4])  : '???') }
                                 else                                                                  { return 'Completed' }   ;break
                    case 'A5]' : return format(player.Ain.Clickables_3[5][5] )  + ' / ' + (player.Ain.Clickables_3[2][2].gt(0) ? format(player.Ain.Clickables_3[5][4]) : '???') ;break
                    case 'A6]' : if(player.Ain.Clickables_3[6][2] .lt(player.Ain.Clickables_3[6][1]))  { return format(player.Ain.Clickables_3[6][5])   + ' / ' + (player.Ain.Clickables_3[5][2].gt(0)  ? format(player.Ain.Clickables_3[6][4])  : '???') }
                                 else                                                                  { return 'Completed' }   ;break
                    case 'A7]' : if(player.Ain.Clickables_3[7][2] .lt(player.Ain.Clickables_3[7][1]))  { return format(player.Ain.Clickables_3[7][5])   + ' / ' + (player.Ain.Clickables_3[6][2].gt(0)  ? format(player.Ain.Clickables_3[7][4])  : '???') }
                                 else                                                                  { return 'Completed' }   ;break
                    case 'A8]' : return format(player.Ain.Clickables_3[8][5] )  + ' / ' + (player.Ain.Clickables_3[1][2].gt(0) ? format(player.Ain.Clickables_3[8][4]) : '???') ;break
                    case 'A9]' : if(player.Ain.Clickables_3[9][2] .lt(player.Ain.Clickables_3[9][1]))  { return format(player.Ain.Clickables_3[9][5])   + ' / ' + (player.Ain.Clickables_3[8][2].gt(0)  ? format(player.Ain.Clickables_3[9][4])  : '???') }
                                 else                                                                  { return 'Completed' }   ;break
                    case 'A10' : if(player.Ain.Clickables_3[10][2].lt(player.Ain.Clickables_3[10][1])) { return format(player.Ain.Clickables_3[10][5])  + ' / ' + (player.Ain.Clickables_3[9][2].gt(0)  ? format(player.Ain.Clickables_3[10][4]) : '???') }
                                 else                                                                  { return 'Completed' }   ;break
                    case 'A11' : return format(player.Ain.Clickables_3[11][5])  + ' / ' + (player.Ain.Clickables_3[8][2].gt(0) ? format(player.Ain.Clickables_3[11][4]) : '???');break
                    case 'A12' : if(player.Ain.Clickables_3[12][2].lt(player.Ain.Clickables_3[12][1])) { return format(player.Ain.Clickables_3[12][5])  + ' / ' + (player.Ain.Clickables_3[11][2].gt(0) ? format(player.Ain.Clickables_3[12][4]) : '???') }
                                 else                                                                  { return 'Completed' }   ;break
                    case 'A13' : if(player.Ain.Clickables_3[13][2].lt(player.Ain.Clickables_3[13][1])) { return format(player.Ain.Clickables_3[13][5])  + ' / ' + (player.Ain.Clickables_3[12][2].gt(0) ? format(player.Ain.Clickables_3[13][4]) : '???') }
                                 else                                                                  { return 'Completed' }   ;break
                }
            },
            unlocked: true,
    ...
    clickables :
    {
        ...
        25:
        {
            ...
            tooltip  :  function()
            {
                return 'It buys as more as it can.<br><br>You can\'t buy layers manually when it\'s on.'
            },
            branches : [22],
            canClick :  function()
            {
        ...
        31:
        {
            ...
            canClick :  function()
            {
                if(player.Ain.Abyss_Inchallenge == 1) return false
        ...
        43:
        {
            ...
            canClick :  function()
            {
                if(player.Ain.Clickables_3[3][2].gte(player.Ain.Clickables_3[3][1])) return false
                if(player.Ain.Abyss_Inchallenge == 1)                                return false
                return player.Ain.Clickables_3[2][2].gte(1)
            },
            onClick :  function()
            {
            ...
            style :  function()
            {
                ...
                if(player.Ain.Clickables_3[3][2].gte(player.Ain.Clickables_3[3][1]))
                {
        ...
        44:
        {
            ...
            canClick :  function()
            {
                if(player.Ain.Clickables_3[4][2].gte(player.Ain.Clickables_3[4][1])) return false
                if(player.Ain.Abyss_Inchallenge == 1)                                return false
                return player.Ain.Clickables_3[3][2].gte(1)
            },
            onClick :  function()
            {
            ...
            style :  function()
            {
                ...
                if(player.Ain.Clickables_3[3][2].gt(0))
                {
                    Style['border']       = '2px solid white'
                    Style['color']        = 'white'
                }
                if(player.Ain.Clickables_3[4][2].gte(player.Ain.Clickables_3[4][1]))
                {
                    Style['background-color'] = '#006600'
                }
                return Style
        ...
        46:
        {
            ...
            canClick :  function()
            {
                if(player.Ain.Clickables_3[6][2].gte(player.Ain.Clickables_3[6][1])) return false
                if(player.Ain.Abyss_Inchallenge == 1)                                return false
                return player.Ain.Clickables_3[1][2].gte(1)
            },
            onClick :  function()
        ...
        47:
        {
            ...
            canClick :  function()
            {
                if(player.Ain.Clickables_3[7][2].gte(player.Ain.Clickables_3[7][1])) return false
                if(player.Ain.Abyss_Inchallenge == 1)                                return false
                return player.Ain.Clickables_3[6][2].gte(1)
            },
            onClick :  function()
            {
            ...
            style :  function()
            {
                ...
                if(player.Ain.Clickables_3[6][2].gt(0))
                {
                    Style['border']       = '2px solid white'
                    Style['color']        = 'white'
                }
                if(player.Ain.Clickables_3[7][2].gte(player.Ain.Clickables_3[7][1]))
                {
                    Style['background-color'] = '#006600'
                }
                return Style
        ...
        49:
        {
            ...
            canClick :  function()
            {
                if(player.Ain.Clickables_3[9][2].gte(player.Ain.Clickables_3[9][1])) return false
                if(player.Ain.Abyss_Inchallenge == 1)                                return false
                return player.Ain.Clickables_3[8][2].gte(1)
            },
            onClick :  function()
            {
            ...
            style :  function()
            {
                ...
                if(player.Ain.Clickables_3[8][2].gt(0))
                {
                    Style['border']       = '2px solid white'
                    Style['color']        = 'white'
                }
                if(player.Ain.Clickables_3[9][2].gte(player.Ain.Clickables_3[9][1]))
                {
                    Style['background-color'] = '#006600'
                }
                return Style
        ...
        410:
        {
            ...
            canClick :  function()
            {
                if(player.Ain.Clickables_3[10][2].gte(player.Ain.Clickables_3[10][1])) return false
                if(player.Ain.Abyss_Inchallenge == 1)                                  return false
                return player.Ain.Clickables_3[9][2].gte(1)
            },
            onClick :  function()
            {
            ...
            style :  function()
            {
                ...
                if(player.Ain.Clickables_3[9][2].gt(0))
                {
                    Style['border']       = '2px solid white'
                    Style['color']        = 'white'
                }
                if(player.Ain.Clickables_3[10][2].gte(player.Ain.Clickables_3[10][1]))
                {
                    Style['background-color'] = '#006600'
                }
                return Style
        ...
        412:
        {
            ...
            canClick :  function()
            {
                if(player.Ain.Clickables_3[12][2].gte(player.Ain.Clickables_3[12][1])) return false
                if(player.Ain.Abyss_Inchallenge == 1)                                  return false
                return player.Ain.Clickables_3[11][2].gte(1)
            },
            onClick :  function()
            {
            ...
            style :  function()
            {
                ...
                if(player.Ain.Clickables_3[11][2].gt(0))
                {
                    Style['border']       = '2px solid white'
                    Style['color']        = 'white'
                }
                if(player.Ain.Clickables_3[12][2].gte(player.Ain.Clickables_3[12][1]))
                {
                    Style['background-color'] = '#006600'
                }
                return Style
        ...
        413:
        {
            ...
            canClick :  function()
            {
                if(player.Ain.Clickables_3[13][2].gte(player.Ain.Clickables_3[13][1])) return false
                if(player.Ain.Abyss_Inchallenge == 1)                                  return false
                return player.Ain.Clickables_3[12][2].gte(1)
            },
            onClick :  function()
            {
            ...
            style :  function()
            {
                ...
                if(player.Ain.Clickables_3[12][2].gt(0))
                {
                    Style['border']       = '2px solid white'
                    Style['color']        = 'white'
                }
                if(player.Ain.Clickables_3[13][2].gte(player.Ain.Clickables_3[13][1]))
                {
                    Style['background-color'] = '#006600'
                }
                return Style
        ...
        52:
        {
            title : 'Completely Wrong Research System',
            style :  function()
            {
                Style = {}
                Style['width']            = '150px'
        ...
        55:
        {
            title : 'Unestimated Ain Depletion',
            style :  function()
            {
                Style = {}
                Style['width']            = '150px'
        ...
        59:
        {
            title :  function()
            {
                if(player.Ain.Abyss_Inchallenge == 0) return 'Enter the challenge'
                else return 'Leave the challenge'
            },
            ...
            onClick :  function()
            {
                switch(player.Ain.Abyss_Inchallenge)
                {
                    case 0 :
                    {
                        player.Ain.Abyss_Inchallenge = player.Ain.Abyss_Select
                        if(player.Ain.Abyss_Inchallenge = 1)
                        {
                            player.Ain.Abyss_Save = []
                            player.Ain.Abyss_Save.push(player.Ain.Deep_Research_Researching)
                            player.Ain.Abyss_Save.push(player.Ain.Deep_Research_Inject)
                            player.Ain.Abyss_Save.push(player.Ain.Deep_Research_Power)
                            player.Ain.Abyss_Save.push(player.Ain.Deep_Research_Gain)
                            player.Ain.Abyss_Save.push(player.Ain.Refactor)
                            player.Ain.Abyss_Save.push(player.Ain.Clickables_3)
                            player.Ain.Abyss_Save.push(player.Ain.Clickables_3_13)
                            player.Ain.Abyss_Save.push(player.Ain.Clickables_2)
                            player.Ain.Abyss_Save.push(player.Ain.Auto_Clickable_1)
                            player.Ain.Abyss_Save.push(player.Ain.Clickables_1)
                            player.Ain.Abyss_Save.push(player.Ain.Clickables_1_Unlock)
                            player.Ain.Abyss_Save.push(player.Ain.points)

                            // 完全清空内容部分
                            player.Ain.Deep_Research_Researching =  0
                            player.Ain.Deep_Research_Inject      =  new Decimal(0)
                            player.Ain.Deep_Research_Power       =  new Decimal(0)
                            player.Ain.Deep_Research_Gain        =  new Decimal(0)
                            player.Ain.Refactor                  = [0,new Decimal(1),new Decimal(1)]
                            player.Ain.Clickables_3              = [0,[0, 0, new Decimal(0),new Decimal(0),new Decimal(0),new Decimal(0),0],
                                                                      [0, 0, new Decimal(0),new Decimal(0),new Decimal(0),new Decimal(0),0],
                                                                      [0, 0, new Decimal(0),new Decimal(0),new Decimal(0),new Decimal(0),0],
                                                                      [0, 0, new Decimal(0),new Decimal(0),new Decimal(0),new Decimal(0),0],
                                                                      [0, 0, new Decimal(0),new Decimal(0),new Decimal(0),new Decimal(0),0],
                                                                      ...
                                                                      [0, 0, new Decimal(0),new Decimal(0),new Decimal(0),new Decimal(0),0]]
                            player.Ain.Clickables_3_13           =  0
                            player.Ain.Clickables_2              = [0,[0, new Decimal(0),new Decimal(0),new Decimal(0)],
                                                                      [0, new Decimal(0),new Decimal(0),new Decimal(0)],
                                                                      [0, new Decimal(0),new Decimal(0),new Decimal(0)],
                                                                      [0, new Decimal(0),new Decimal(0),new Decimal(0)],
                                                                      [0, new Decimal(0),new Decimal(0),new Decimal(0)],
                            ...
                            player.Ain.Clickables_1              = [0,[0, new Decimal(0),new Decimal(0),new Decimal(0)],
                                                                      ...
                                                                      [0, new Decimal(0),new Decimal(0),new Decimal(0)],
                                                                      [0, new Decimal(0),new Decimal(0),new Decimal(0)]]
                            player.Ain.Clickables_1_Unlock       = [0,1,0,0,0,0,0,0,0]
                    ...
                    default : 
                    {
                        if(player.Ain.Abyss_Inchallenge == 1)
                        {
                            if(player.Ain.Abyss[1][4].gte(player.Ain.Abyss[1][3]))
                            {
                                player.Ain.Abyss[1][3] = player.Ain.Abyss[1][4]
                                player.Ain.points = new Decimal(10)
                            }
                            player.Ain.points                    = player.Ain.Abyss_Save[11]
                            player.Ain.Clickables_1_Unlock       = player.Ain.Abyss_Save[10]
                            player.Ain.Clickables_1              = player.Ain.Abyss_Save[9]
                            player.Ain.Auto_Clickable_1          = player.Ain.Abyss_Save[8]
                            player.Ain.Clickables_2              = player.Ain.Abyss_Save[7]
                            player.Ain.Clickables_3_13           = player.Ain.Abyss_Save[6]
                            player.Ain.Clickables_3              = player.Ain.Abyss_Save[5]
                            player.Ain.Refactor                  = player.Ain.Abyss_Save[4]
                            player.Ain.Deep_Research_Gain        = player.Ain.Abyss_Save[3]
                            player.Ain.Deep_Research_Power       = player.Ain.Abyss_Save[2]
                            player.Ain.Deep_Research_Inject      = player.Ain.Abyss_Save[1]
                            player.Ain.Deep_Research_Researching = player.Ain.Abyss_Save[0]
                            player.Ain.Abyss_Save = []
                        }
                    }
                    player.Ain.Abyss_Inchallenge = 0
                }
            },
            style :  function()
            {
        ...
        61:
        {
            ...
            display :  function()
            {
                ...
                {
                    Description = '<h3>Multiply Ain gain based on your hierarchy<br><br>*BUT RESETS THEM*<br>*AND RESET AINS*</h3>'
                ...
                {
                    Description = '<h3>Multiply Ain gain based on your hierarchy and the three<br>buyables in [Simple Research]<br><br>*BUT RESETS THEM*<br>*AND RESET AINS*</h3>'
                    Replace     = '<h2>×' + format(player.Ain.Refactor[1]) + '</h2>'
                    Effect      = '<h2>Current: ×' + format(player.Ain.Refactor[2])
                    return  Description + '<br>' + Replace + '<br><h2>-------------------------</h2><br>' + Effect
                }
...
// ----------------------------------------------------------
//
//     1. 将高研究等级上限写入 StartData 并修改挑战部分
//      ✔. Serious Mistake 中自己的效果不生效
//     3. 对代码进行优化
//     4. 成就
//      ✔. 高研究无法研究时不显示内容
//      ✔. 挑战退出时保留内容
