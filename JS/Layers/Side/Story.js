addLayer('Story',
{
    ...
    update :  function(diff)
    {
        ...
        if(player.Story.In_Story == 1)
        {
            ...
            if((player.Story.Story_Part == '1.1')&&(player.Story.Story_Time == 57)) player.Story.Text_Story = '<h1>You open your eyes<br><br>A</h1>'
            if((player.Story.Story_Part == '1.1')&&(player.Story.Story_Time == 58)) player.Story.Text_Story = '<h1>You open your eyes<br><br>An</h1>'
            if((player.Story.Story_Part == '1.1')&&(player.Story.Story_Time == 59)) player.Story.Text_Story = '<h1>You open your eyes<br><br>And look around<br><br>But only find nothing.<h1>'
            if((player.Story.Story_Part == '1.1')&&(player.Story.Story_Time == 60)) player.Story.Text_Story = '<h1>You open your eyes<br><br>And look around<br><br>But only find nothing.<h1>'
            if((player.Story.Story_Part == '1.1')&&(player.Story.Story_Time == 61)) player.Story.Text_Story = '<h1>You open your eyes<br><br>And look around<br><br>But only find nothing.<h1>'
            if((player.Story.Story_Part == '1.1')&&(player.Story.Story_Time == 62)) player.Story.Text_Story = '<h1>You open your eyes<br><br>And look around<br><br>But only find nothing.<h1>'
            if((player.Story.Story_Part == '1.1')&&(player.Story.Story_Time == 63)) player.Story.Text_Story = '<h1>You open your eyes<br><br>And look around<br><br>But only find nothing.<h1>'
            if((player.Story.Story_Part == '1.1')&&(player.Story.Story_Time == 64)) player.Story.Text_Story = '<h1>You open your eyes<br><br>And look around<br><br>But only find nothing.<h1>'
            if((player.Story.Story_Part == '1.1')&&(player.Story.Story_Time == 65)) player.Story.Text_Story = '<h1>You open your eyes<br><br>And look around<br><br>But only find nothing.<h1>'
            if((player.Story.Story_Part == '1.1')&&(player.Story.Story_Time == 66)) player.Story.Text_Story = '<h1>You open your eyes<br><br>And look around<br><br>But only find nothing.<h1>'
